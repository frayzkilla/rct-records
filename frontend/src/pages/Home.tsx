  ...
  return (
    <div className="mt-20 bg-black text-white font-sans">
      <section className="py-12 md:py-24 px-4 sm:px-6 text-center bg-gradient-to-b from-black via-zinc-900 to-black">
        ...
        <p id="welcome-phrase" className="mt-4 md:mt-6 text-lg md:text-xl max-w-xl mx-auto text-[#E0C068] font-mono uppercase tracking-widest drop-shadow-lg px-2">
          Добро пожаловать в звук <br className="block sm:hidden" />Raw Crownz
        </p>
